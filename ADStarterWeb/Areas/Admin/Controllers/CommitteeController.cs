...
namespace ADStarterWeb.Areas.Admin.Controllers
{
    ...
    public class CommitteeController : Controller
    {
        ...
        public CommitteeController(UserManager<ApplicationUser> userManager, RoleManager<IdentityRole> roleManager, IUnitOfWork unitOfWork)
        {
        ...
        public async Task<IActionResult> CommitteeList()
        {
            ...
            var committeeVm = new List<CommitteeVM>();
            ...
            foreach (var user in users)
            {
                ...
                if (roles.Contains("Committee"))
                {
                    ...
                    var thisViewModel = new CommitteeVM
                    {
        ...
        [HttpPost]
        public async Task<IActionResult> Update(CommitteeVM model)
        {
